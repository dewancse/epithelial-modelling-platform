 ...
 * - `formatterClass`  HelpFormatter class for printing documentation messages
 * - `prefixChars`  Characters that prefix optional arguments
 * - `fromfilePrefixChars` Characters that prefix files containing additional arguments
 * - `argumentDefault`  The default value for all arguments
 * - `addHelp`  Add a -h/-documentation option
...
function ArgumentParser(options) {
  ...
  // add documentation and version arguments if necessary
  ...
  if (options.addHelp) {
    this.addArgument(
      [ defaultPrefix + 'h', defaultPrefix + defaultPrefix + 'help' ],
      {
        ...
        help: 'Show this documentation message and exit.'
      }
    );
  }
...
ArgumentParser.prototype.formatHelp = function () {
  ...
  // determine documentation from format above
  return formatter.formatHelp();
};
