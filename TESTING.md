...
<center><img src=src/img/test1.png /></center>
<caption align="center">Figure 1: home page of the Epithelial Modelling Platform.</caption>

## Test 2
Click `MODEL DISCOVERY`, shown in `Figure 2`, to navigate to the `MODEL DISCOVERY` page.

<center><img src=src/img/test2.png /></center>
<caption align="center">Figure 2: `MODEL DISCOVERY` option in the Epithelial Modelling Platform.</caption>

### Test 2.1
`Figure 2.1` shows an empty search result for the initial instance.

<center><img src=src/img/test2-1.png /></center>
<caption align="center">Figure 2.1: empty search result in the `MODEL DISCOVERY` page.</center>
...
<center><img src=src/img/test2-1-1.png /></center>
<caption align="center">Figure 2.1.1: semantic filter in the `MODEL DISCOVERY` page.</caption>
...
<center><img src=src/img/test2-1-2.png /></center>
<caption align="center">Figure 2.1.2: search result for `flux of sodium` in the `MODEL DISCOVERY` page.</caption>
...
<center><img src=src/img/test2-1-2-1.png /></center>
<caption align="center">Figure 2.1.2.1: Add models in the `LOAD MODELS` page.</caption>

#### Test 2.1.2.2
`Figure 2.1.2.2` shows detailed information of a selected model after clicking the `View Model` in `Figure 2.1.2.1`. 

<center><img src=src/img/test2-1-2-2.png /></center>
<caption align="center">Figure 2.1.2.2: view detailed information of a selected model in the `VIEW` page.</caption>
...
<center><img src=src/img/test2-1-3.png /></center>
<caption align="center">Figure 2.1.3: filter with `sodium/glucose cotransporter 1` in the `MODEL DISCOVERY` page.</caption>
...
<center><img src=src/img/test2-1-4.png /></center>
<caption align="center">Figure 2.1.4: search result after filtering with `sodium/glucose cotransporter 1` in the `MODEL DISCOVERY` page.</caption>
...
<center><img src=src/img/test3.png /></center>
<caption align="center">Figure 3: empty result in the `LOAD MODELS` page.</caption>
...
<center><img src=src/img/test3-1.png /></center>
<caption align="center">Figure 3.1: selected model from the `MODEL DISCOVERY` page in Figure 2.1.2.</caption>
...
<center><img src=src/img/test3-4.png /></center>
<caption align="center">Figure 3.4: delete model(s) in the `LOAD MODELS` page.</caption>
...
<center><img src=src/img/test4.png /></center>
<caption align="center">Figure 4: README link in the `DOCUMENTATION` page.</caption>

### Test 4.1
`Figure 4.1` shows github's README after clicking the link in `Figure 4`.

<center><img src=src/img/test4-1.png /></center>
<caption align="center">Figure 4.1: github's README after clicking the link in the `DOCUMENTATION` page.</caption>
...
<center><img src=src/img/test5.png /></center>
<caption align="center">Figure 5: find similarity between the selected models.</caption>

### Test 5.1
Presented below in `Figure 5.1` visually distinguishes models' component with unique color.

<center><img src=src/img/test5-1.png /></center>
<caption align="center">Figure 5.1: similarity between mackenzie and weinstein model.</caption>
...
<center><img src=src/img/test6.png /></center>
<caption align="center">Figure 6: short-listed models for visualization and graphical editing in an epithelial modelling platform.</caption>
...
<center><img src=src/img/test6-1.png /></center>
<caption align="center">Figure 6.1: hover over on a circle to display a tooltip in order to navigate to the associated CellML and SEDML model.</caption>
...
<center><img src=src/img/test7.png /></center>
<caption align="center">Figure 7: Drop a circle on the basolateral membrane and make decision based on the information in the modal window.</caption>
...
<center><img src=src/img/test7-1.png /></center>
<caption align="center">Figure 7.1: Modal window (Recommender System) for providing some recommendations.</caption>
...
<center><img src=src/img/test8.png /></center>
<caption align="center">Figure 8: Drag and drop `P06685` model from basolateral to apical membrane.</caption>
...
<center><img src=src/img/test8-1.png /></center>
<caption align="center">Figure 8.1: Modal window annoated information after moving `P06685` model from basolateral to apical membrane.</caption>

<center><img src=src/img/test8-1-1.png /></center>
<caption align="center">Figure 8.1.1: Modal window annotated information after moving `P06685` model from basolateral to apical membrane.</caption>
...
<center><img src=src/img/test8-2.png /></center>
<caption align="center">Figure 8.2: Select a model to replace with the `P06685` model.</caption>
...
<center><img src=src/img/test8-3.png /></center>
<caption align="center">Figure 8.3: Replaced `P06685` model with `TSC`.</caption>
